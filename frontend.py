...
def search_command():
    """
    Is looking for selected parameter in db
    """
    list1.delete(0,END)
...
b3=Button(window, width=12,text="add", command=add_command)
...
b6=Button(window, width=12,text="close")
